...
#     output
# This is an infinite loop. ออกแบบนี้เรื่อยๆ

# ==================trst 1===================================
# def find_of_three(start:int, end:int) -> list:
#     result =[]
#     for i in range(start,end):
#         if i % 3 ==0:
#             result.append(i)
#     return result
# print(find_of_three(10,25))

# ===================== 2 ==================================
# def find_of_three_four(start:int, end:int) -> list:
#     tam = []
#     for i in range(start,end):
#         if i % 3 == 0  and  i % 4 == 0:
#             tam.append(i)
#     return tam
# print(find_of_three_four(10,50))
